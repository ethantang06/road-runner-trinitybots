...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.14385; // in; distance between the left and right wheels 18.5mm
    public static double FORWARD_OFFSET = -8; // in; offset of the lateral wheel, 17mm

    private Encoder leftEncoder, rightEncoder, backEncoder;
    public static double X_MULTIPLIER = 1.02; // 71/68.66569952266414; // multiplier in the X direction
    //ublic static double Y_MULTIPLIER = 0.8954179889101329; //1.1928; //multiplier in the Y direction
    public static double Y_MULTIPLIER = 1.019; //71/57.0453146394784
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap) {
        ...
        backEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "left_back_drive"));
