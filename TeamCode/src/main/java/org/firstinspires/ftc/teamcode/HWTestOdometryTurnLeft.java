 ...
 *
 **/
@TeleOp(name="HWTestOdometryTurnLeft", group="Linear Opmode")

public class HWTestOdometryTurnLeft extends LinearOpMode {
    ...
    private String m_test_program_name = "Odometry_turnleft";
