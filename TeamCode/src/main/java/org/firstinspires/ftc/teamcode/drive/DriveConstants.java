...
public class DriveConstants {
    ...
    public static final double TICKS_PER_REV = 537.7; //Gobilda 5303 motor, Encoder Resolution	537.7 PPR at the Output Shaft
...
public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0,
    ...
    public static double GEAR_RATIO = 1.06; // output (wheel) speed / input (motor) speed, gobilda motor gear ratio: 19.2:1
    public static double TRACK_WIDTH = 13.228; // in
     ...
     */
    public static double MAX_VEL = 61.7433; //52.48180821614297;
    public static double MAX_ACCEL = 61.7433;

//    public static double MAX_ANG_VEL = 0.28333333134651184; // 6.22.2022 - drive encoder
