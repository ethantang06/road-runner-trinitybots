 ...
 *
 **/
@TeleOp(name="HWTestOdometryStrafeLeft", group="Linear Opmode")

public class HWTestOdometryStrafeLeft extends LinearOpMode {
    ...
    private String m_test_program_name = "Odometry_strafeleft";
